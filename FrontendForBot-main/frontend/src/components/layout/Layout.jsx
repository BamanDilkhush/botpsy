...
const Layout = ({ children }) => {
  return (
    // keep min-h-screen and flex layout; use relative so absolute blobs can be positioned
    <div className="relative min-h-screen flex flex-col bg-background font-sans text-text overflow-hidden">
